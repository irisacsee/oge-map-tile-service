...
import oge.conf.coverage.OGEDataType
...
object TileSerializer {
   ...
   * @return
   */
  def deserializeTileData(platform: String, tileBytes: Array[Byte], tileSize: Int, dataType: OGEDataType): Tile = {
    dataType match {
      case OGEDataType.int8raw => deserialize2ByteType(tileBytes, tileSize, CellType.fromName("int8raw"))
      case OGEDataType.uint8raw => deserialize2ByteType(tileBytes, tileSize, CellType.fromName("uint8raw"))
      case OGEDataType.int8 => deserialize2ByteType(tileBytes, tileSize, CellType.fromName("int8raw"))
      case OGEDataType.uint8 => deserialize2ByteType(tileBytes, tileSize, CellType.fromName("uint8raw"))
      case OGEDataType.int16raw => deserialize2ShortType(tileBytes, tileSize, CellType.fromName("int16raw"))
      case OGEDataType.uint16raw => deserialize2ShortType(tileBytes, tileSize, CellType.fromName("uint16raw"))
      case OGEDataType.int16 => deserialize2ShortType(tileBytes, tileSize, CellType.fromName("int16raw"))
      case OGEDataType.uint16 => deserialize2ShortType(tileBytes, tileSize, CellType.fromName("uint16raw"))
      case OGEDataType.int32raw => deserialize2IntType(tileBytes, tileSize, CellType.fromName("int32raw"))
      case OGEDataType.int32 => deserialize2IntType(tileBytes, tileSize, CellType.fromName("int32raw"))
      case OGEDataType.float32raw => deserialize2FloatType(tileBytes, tileSize, CellType.fromName("float32raw"))
      case OGEDataType.float32 => deserialize2FloatType(tileBytes, tileSize, CellType.fromName("float32raw"))
      case OGEDataType.float64raw => deserialize2DoubleType(tileBytes, tileSize, CellType.fromName("float64raw"))
      case OGEDataType.float64 => deserialize2DoubleType(tileBytes, tileSize, CellType.fromName("float64raw"))
